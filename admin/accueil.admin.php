  ...
  <?php require_once '../inc/nav.inc.php'; ?>
   ...
   <div class="container">      
        <section class="row m-4 justify-content-center">
            ...
            <?php echo $contenu02; ?>
            <?php
             $requete = $pdoMAB->query( " SELECT * FROM films, categories WHERE films.id_film = categories.id_categorie " );
            ...
            // https://www.w3schools.com/php/func_string_html_entity_decode.asp
              while ( $ligne = $requete->fetch( PDO::FETCH_ASSOC )) { ?>
                <tr>
                    ...
                    <td><a href="fiche_film.php?id_film=<?php echo $ligne['id_film']; ?>">maj</a></td>
                    <td><a href="?action=supprimer&id_film=<?php echo $ligne['id_film']; ?>" onclick="return(confirm('Voulez-vous supprimer ce film id  <?php echo $ligne['id_film']; ?> ? '))">suppr</a></td>
                </tr>
