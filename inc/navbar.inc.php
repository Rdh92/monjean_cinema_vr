    <!-- <header class="">
        <div class="container-fluid justify-content-center p-5">
            <div class="">
                ...
                <!-- <a class="navbar-brand" href="index.php">MONTJEAN CINEMA
                </a>
            </div>
            <div class="">
                <a class="navbar-brand" href="index.php">
                <i class="bi bi-film m-2"></i><i class="bi bi-film m-2"></i><i class="bi bi-film m-2"></i><i class="bi bi-film m-2"></i><i class="bi bi-film m-2"></i><i class="bi bi-film m-2"></i></a>
            </div>
        </div>
    </header> -->
            ...
            <div class="">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">                  
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item m-4">
                            <a class="nav-link" href="inscription.php">Nouveau ici ? Inscrivez-vous !</a>
                        </li>
                        <li class="nav-item m-4">
                            <a class="nav-link" href="contact.php"><i class=""></i>Contact</a>
                        </li>
                        <li class="nav-item m-4">
                            <a class="nav-link" href="connexion.php"><i class="bi bi-person-fill"></i>Mon compte</a>
                        </li>           
                        <li class="nav-item m-4">
                            <a class="nav-link"  href="panier.php"><i class="bi bi-handbag-fill"></i>Mon panier</a>
                        </li>
                        <!-- <li class="nav-item m-4">
                            <a class="nav-link" href="profil.php"></i>Profil</a>
                        </li>
                        <li class="nav-item m-4">
